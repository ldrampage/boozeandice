...
public class IndexService implements Serializable {
	...
	private static final long serialVersionUID = 7059245276156219816L;
	...
	private final CategoryService productCatService;
	private final Utilities utility;
	private final ProductStockService productStockService;
	private final TransactionService transactionService;
	private final UserService userService;
	private final TransactionItemService transactionItemServ;
	private final AddressRepository addressRepository;
	private final DiscountRepository discountRepo;
	private final ShipmentRepository shipmentRepository;
	private final UserActivityLogRepository userActLogRepo;
	...
	public IndexService(ProductService productService, CustomerService customerService, CashDrawerService cashDrawerService,
			CategoryService productCatService, Utilities utility, ProductStockService productStockService, TransactionService transactionService,
			UserService userService, TransactionItemService transactionItemServ, AddressRepository addressRepository, DiscountRepository discountRepo,
			ShipmentRepository shipmentRepository, UserActivityLogRepository userActLogRepo) {
		...
		this.transactionItemServ = transactionItemServ;
		this.addressRepository = addressRepository;
		this.discountRepo = discountRepo;
		this.shipmentRepository = shipmentRepository;
		this.userActLogRepo = userActLogRepo;
	...
	public void invoiceProcessPrep(Model model, @RequestParam Map<String, String> parameters) {
...
//		}
	...
	public void invoicePrintPagePrep(Model model, String transactionId) {
	...
	public void getProcessPayment(Model model, String transactionId) {
		Transaction transaction = transactionService.getById(Long.valueOf(transactionId));
	...
	@Transactional(propagation=Propagation.REQUIRED)
	public String processPaymentPrep(Model model, @RequestParam Map<String, String> parameters) {
...
//		}
	...
	@Transactional(propagation=Propagation.REQUIRED)
	public void posPrepProcess(Model model, Map<String, String> parameters) {
		...
		if (parameters.get("searchByProductName") != null) {
			// productList =
			// productService.getByNameContainingAndStocksGreaterThan(parameters.get("searchByProductName"));
