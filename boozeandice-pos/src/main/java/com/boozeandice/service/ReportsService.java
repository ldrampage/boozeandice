...
import com.boozeandice.controller.ReportsController;
...
public class ReportsService implements Serializable {
	...
	private static final long serialVersionUID = -319586647638179577L;
	...
	public void monthlySalesReportPage(Model model) {
	...
	public void salesReportPage(Model model) {
		// Sales Report Tab Start
		// Daily Sales Report
	...
	public void zreportPrintPage(Model model, Map<String, String> parameters) {
	...
	public void zReportsPage(Model model, String zdate)
			throws Exception {
