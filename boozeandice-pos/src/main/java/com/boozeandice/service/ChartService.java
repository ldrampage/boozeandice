...
public class ChartService {
	...
	public void chartPageProcess(Model model, @RequestParam Map<String, String> parameters) {
	...
	public void chartPagePrep(Model model) {
		// Monthly Recap Chart Start
		List<MonthlyRecapChartVO> monthlyRecapChartVoList = null;
		if (model.getAttribute("mrcfty_date") != null) {
			monthlyRecapChartVoList = reportChartRepo
					.getMonthlyRecapChartByYear(model.getAttribute("mrcfty_date").toString());
		} else {
